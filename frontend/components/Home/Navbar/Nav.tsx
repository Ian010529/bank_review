      ...
      <div className="w-[90%] mx-auto">
        <div className="flex justify-between items-center h-16">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center space-x-1 px-2
                    lg:px-3 py-2 rounded-md text-xs lg:text-sm font-medium
                    transition-colors duration-200 whitespace-nowrap ${isActive ? 'text-blue-600 bg-blue-50' : 'text-gray-700 hover:text-blue-600'}`}
                >
          ...
          <div className="flex items-center space-x-2 lg:space-x-4">
            <Link
              href={'/want-to-know'}
              className="lg:flex hidden items-center space-x-2 px-3 py-2
              text-grey-700 hover:text-blue-600 w-full text-left"
            >
